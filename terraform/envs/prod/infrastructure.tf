# Shared Infrastructure for Both PaaS and IaaS - Production Environment
...
# Network with all subnets for both PaaS and IaaS (Production VNet range)
module "network" {
  source    = "../../modules/network"
  rg_name   = module.rg.rg_name
  vnet_name = "tc-${var.environment}-vnet-frc-01"
  location  = var.location
  address_space = ["10.1.0.0/16"]  # Production VNet range
  subnets = [
    {
      name     = "subnet-web"
      prefix   = "10.1.1.0/24"
