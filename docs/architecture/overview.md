...
graph TB
    ...
    subgraph "Azure - Resource Group: rg-nan_1"
        ...
        subgraph "Approche IaaS"
            LB[Load Balancer<br/>tc-dev-lb-frc-01]
            VMSS[VM Scale Set<br/>tc-dev-vmss-frc-01<br/>2-5 instances]
        end
    end
...
- Pas d'accès SSH direct aux VMs (NAT via Load Balancer pour IaaS)
